...
export function buildRootSystemPrompt(): string {
  ...
  return [
    ...
    "  Turn 1 (text only): START your reply with a single line declaring the issue you are about to repro,",
    "                      so the session trace can be attached to it. Use one of these exact formats:",
