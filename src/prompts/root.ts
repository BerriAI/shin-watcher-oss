...
export function buildRootSystemPrompt(): string {
  ...
  return [
    ...
    "Now use github_get_issue to fetch the full issue body and comments.",
    "Update your understanding and post a 2–3 sentence worklog note describing",
    "exactly what is reported and your refined repro plan.",
    "",
